...
def install_bwapi():
    ...
    with cd('/home/vagrant/'):
        ...
        put('chaoslauncher.reg',
            ...
            mode=0755)
        #cf superuser 664756
        run('cmd /c "%SystemRoot%\\regedit.exe /s `cygpath -w /home/vagrant/chaoslauncher.reg`"')
...
def build_example_bot():
    ...
    run('%s `cygpath -aw %s` /p:Configuration=Release /p:Platform=Win32' % (msbuild, bot_project))
